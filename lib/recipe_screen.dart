...
class _RecipeScreenState extends State<RecipeScreen> with TickerProviderStateMixin {
  ...
  final List<String> _categories = [
    'Tất cả', 'Món chính', 'Món phụ', 'Tráng miệng',
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: IconButton(
              icon: const Icon(Icons.notifications_outlined, color: Color(0xFFFF6B6B)),
              onPressed: () {},
            ),
          ),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Tìm kiếm công th���c nấu ăn...',
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildStatItem('Công thức', '${_currentUser?.recipesCreated ?? 0}'),
                    _buildStatItem('Yêu thích', '${_currentUser?.favoriteRecipes.length ?? 0}'),
                    _buildStatItem('Cấp độ', _currentUser?.isAdmin == true ? 'Admin' : 'User'),
                  ],
                ),
              ],
            ),
